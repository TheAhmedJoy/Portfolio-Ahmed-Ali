    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] max-lg:py-8 py-4 flex items-center justify-between z-50 
                ...
                <a href="#top" >
                    <Image src={isDarkMode ? assets.logo_dark : assets.logo} className='w-28 cursor-pointer' alt="Navbar Logo" />
                </a>
                ...
                <div className="flex items-center gap-4">
                    <button onClick={() => setIsDarkMode((prev) => !prev)}>
                        <Image src={isDarkMode ? assets.sun_icon : assets.moon_icon} className="w-6 cursor-pointer" alt="Dark Mode Icon" />
                    </button>
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full font-Ovo dark:border-white/50">
                        Contact
                        <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className="w-3" alt="Contact Me arrow" />
                    </a>
                    <button className="block md:hidden ml-3">
                        <Image src={isDarkMode ? assets.menu_white : assets.menu_black} className="w-6 cursor-pointer" alt="Burger Menu Icon" onClick={openSideNav}/>
                    </button>
                </div>
                ...
                <ul className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500
                    ...
                    <div className="absolute right-6 top-6" onClick={closeSideNav}>
                        <Image src={isDarkMode ? assets.close_white : assets.close_black} className="w-5 cursor-pointer" alt="Close Small Screen Navbar" />
                    </div>
                    <li>
