    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center">
            <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{duration: 0.8, type: 'spring', stiffness: 100}} viewport={{once: true}}>
                <Image src={assets.profile_img} className="rounded-full w-32 mb-3" alt="Portrait of Ahmed Ali" />
            </motion.div>
            <motion.p initial={{y: -20, opacity: 0}} whileInView={{y: 0, opacity: 1}} transition={{duration: 0.6, delay: 0.3}} viewport={{once: true}}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                hover:bg-neutral-200 dark:hover:bg-neutral-200 duration-500" download>
                    My Resume
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/ahmedjoyali/"
                className="px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black hover:bg-neutral-200
                ...
                target="_blank" rel="noopener noreferrer" href="https://github.com/TheAhmedJoy"
                ...
                duration-500">
                    GitHub
                    <span className="sr-only">(opens in a new tab)</span>
                    <Image src={assets.arrow_icon_dark} className="w-3" alt="" />
                </motion.a>
            </div>
        </div>
    )
